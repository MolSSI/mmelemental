...
class NonBonded(ProtoModel):
    ...
    def from_file(
        ...
        **kwargs,
        ...
        """
        Constructs a NonBonded object from a file.
        Parameters
        ----------
        filename: str
        ...
        **kwargs: Optional[Dict[str, Any]], optional
        ...
        -------
        NonBonded
            A constructed NonBonded object.
        """
    ...
    @classmethod
    def from_data(cls, data: Any, **kwargs) -> "NonBonded":
        """
        Constructs a NonBonded object from a data object.
        Parameters
        ----------
        data: Any
            Data to construct NonBonded from.
        **kwargs: Optional[Dict[str, Any]], optional
    ...
    def to_file(
        ...
        **kwargs: Dict[str, Any],
        ...
        """Writes the NonBonded to a file.
        Parameters
        ----------
        filename : str
    ...
    def to_data(
        ...
        **kwargs: Dict[str, Any],
        ...
        """
        Constructs a toolkit-specific data object from MMSchema NonBonded.
        ...
        **kwargs: Optional[Dict[str, Any]]
        ...
        -------
        ToolkitModel
            Toolkit-specific NonBonded object
        """
        raise NotImplementedError
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, dict):
            other = NonBonded(**other)
        elif isinstance(other, NonBonded):
            pass
        else:
